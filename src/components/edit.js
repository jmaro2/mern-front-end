...
export default function Edit() {
  ...
  async function onSubmit(e) {
    ...
    const editedPerson = {
      title: form.title,
      enable_web_output: form.enable_web_output,
      repository: form.repository,
      classification: form.classification,
      subclass: form.subclass,
      collection_identifier: form.collection_identifier,
      sort_title: form.sort_title,
      normal_date_start: form.normal_date_start,
      normal_date_end: form.normal_date_end,
      inclusive_date: form.inclusive_date,
      predominant_date: form.predominant_date,
      material_type: form.material_type,
      extent: form.extent,
      extent_unit: form.extent_unit,
      finding_aid_author: form.finding_aid_author,
      creators: form.creators,
      primary_creator: form.primary_creator,
      abstract: form.abstract,
      scope: form.scope,
      arrangement: form.arrangement,
      alt_extent_stmt: form.alt_extent_stmt,
      biographical_historical_note: form.biographical_historical_note,
      biographical_historical_author: form.biographical_historical_author,
      subjects: form.subjects,
      languages: form.languages,
      initial_date_acquired: form.initial_date_acquired,
      source: form.source,
      method: form.method,
      appraisal_info: form.appraisal_info,
      accruals_additions: form.accruals_additions,
      custodial_history: form.custodial_history,
      access_general: form.access_general,
      use_rights: form.use_rights,
      physical: form.physical,
      technical: form.technical,
      other_url: form.other_url,
      other_note: form.other_note,
      books: form.books,
      related_materials: form.related_materials,
      related_materials_url: form.related_materials_url,
      related_publications: form.related_publications,
      separated_materials: form.separated_materials,
      original_copy_note: form.original_copy_note,
      original_copy_url: form.original_copy_url,
      preferred_citation: form.preferred_citation,
      rules_used: form.rules_used,
      processing_info: form.processing_info,
      revision_history: form.revision_history,
      publication_date: form.publication_date,
      publication_note: form.publication_note,
      written_in: form.written_in,
    };
